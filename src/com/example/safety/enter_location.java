...
public class enter_location extends Activity {
        ...
        public void onClick(View v) {
                switch(v.getId()){
                    case R.id.locationButton:
                        ...
                        String ourUrl = "someurl";

                        EditText startEdit = (EditText)findViewById(R.id.startLocation);
                        EditText destEdit = (EditText)findViewById(R.id.destinationLocation);

                        locationData[0] = startEdit.getText().toString();
                        locationData[1] = destEdit.getText().toString();
                        POST(ourUrl, locationData);
                }
            }
    };
    ...
    public static String POST(String url, String[] info){
        ...
        try {
            ...
            jsonObject.accumulate("startLocation", info[0]);
            jsonObject.accumulate("destinationLocation", info[1]);
